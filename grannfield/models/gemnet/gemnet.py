...
from grannfield.utils.utils import get_max_neighbors_mask, radius_graph_pbc, get_pbc_distances, compute_neighbors
...
class GemNetT(nn.Module):
    ...
    def select_edges(
        ...
        if torch.any(empty_image):
            raise ValueError(
                ...
                # f"sid={data['sid'][empty_image]}, fid={data['sid'][empty_image]}"
            )
    ...
    def generate_interaction_graph(self, data):
        ...
        if self.use_pbc:
            ...
            V_st = -out["distances_vec"] / D_st[:, None]
            ...
            cell_offsets = torch.zeros(
                edge_index.shape[1], 3, device=data['positions'].device
            )
    ...
    def forward(self, data):
        ...
        if self.regress_forces:
            ...
            return out  # (nMolecules, num_targets), (nAtoms, 3)
        else:
            out['energy'] = E_t
            return out
