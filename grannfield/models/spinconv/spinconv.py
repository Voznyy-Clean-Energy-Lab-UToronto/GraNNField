...
class Spinconv(nn.Module):
    ...
    def forward(self, data):
        ...
        self.num_atoms = len(data['atomic_numbers'].long())
    ...
    def _forward_helper(
        ...
        energy = scatter(x, edge_index[1], dim=0, dim_size=data['n_atoms']) / (
    ...
    def _init_edge_rot_mat(self, data, edge_index, edge_distance_vec):
        ...
        num_atoms = len(data['atomic_numbers'].long())
